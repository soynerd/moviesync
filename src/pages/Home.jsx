...
export default function HomePage() {
  return (
    <div className="min-h-screen bg-gradient-to-r from-blue-50 to-purple-100 flex flex-col items-center text-center px-6 py-40">
      ...
      >
        Discover movies, TV shows, and anime. Get detailed information, watch
        trailers, and explore what's trending!
        <br />
        Note : Backend is not active and API take time to load depending on your
        connectivity.
      </motion.p>
